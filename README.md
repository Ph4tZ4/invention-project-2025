...
- **LED จำนวน 2 ตัว**: สีแดง, สีเขียว (ขนาด 5mm)
- **ตัวต้านทาน 220Ω จำนวน 2 ตัว** (สำหรับจำกัดกระแส LED)
...
- **เซ็นเซอร์**: GPIO4, GPIO5, GPIO18, GPIO19, GPIO25, GPIO26 (สำหรับช่อง A1, A2, B1, B2, C1, C2)
- **LED**: GPIO32 (แดง), GPIO33 (เขียว) - ทั้งหมดใช้ตัวต้านทาน 220Ω
...
### ไฟแสดงสถานะ LED
- 🟢 **ไฟเขียว**: มีช่องว่าง (รถจอด 0-5 คัน)
- 🔴 **ไฟแดง**: ลานจอดเต็ม (รถจอด 6 คัน)
...
เซ็นเซอร์ 3 (ช่อง B1) เริ่มต้นแล้วที่ GPIO18
เซ็นเซอร์ 4 (ช่อง B2) เริ่มต้นแล้วที่ GPIO19
